Pod::Spec.new do |s|   
 s.name = 'NIMSDK'     
 s.version = '8.3.0-hotfix-20210317'
 s.summary = 'Netease IM SDK'
 s.homepage = 'http://netease.im'
 s.license = { :'type' => 'Copyright', :'text' => ' Copyright 2021 Netease '}
 s.authors = 'Netease IM Team'  
 s.source = { :http => 'https://yx-web-nosdn.netease.im/quickhtml/assets/yunxin/im/sdk/hotfix/NIM_iOS_SDK_v8.3.0-hotfix-20210317.zip'}  
 s.platform = :ios, '9.0'  
